...
(function (MenuUpdateStep) {
    MenuUpdateStep["CheckForUpdates"] = "アップデートを確認";
    MenuUpdateStep["CheckingForUpdates"] = "アップデートを確認中...";
    MenuUpdateStep["DownloadingUpdate"] = "アップデートをダウンロード中...";
    MenuUpdateStep["RestartToUpdate"] = "再起動してアップデート";
