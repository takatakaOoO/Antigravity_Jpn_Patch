...
<body>
  ...
  <div class="container">
    ...
    <div id="step-setup" class="step active">
      ...
      <div class="text" style="font-size: 13px; opacity: 0.6; letter-spacing: 0.03em;">セットアップ中…</div>
    </div>
    ...
    <div id="step-ask" class="step">
      ...
      <h1>新しい Antigravity へようこそ！</h1>
      <p>Antigravity はエージェントを中心に再設計されました。コードエディタが必要な場合は、<b>Antigravity IDE</b> として別途ダウンロードできます。</p>
      
      <label class="checkbox-label">
        <input type="checkbox" id="chk-download" checked>
        <span class="custom-checkbox"></span>
        <span>Antigravity IDE をダウンロード</span>
      </label>

      <div class="button-group">
        <button class="btn-primary" id="btn-skip">新しい Antigravity を体験する</button>
      </div>
    </div>
